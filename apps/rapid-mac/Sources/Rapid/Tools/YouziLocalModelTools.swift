...
final class YouziLocalModelTools {
    ...
    enum Failure: String, Error {
        ...
        case task_unavailable, file_unavailable, generation_failed, output_too_large
    }
    ...
    3. Plan a short book (up to 8 pages). Generate each illustration with youzi_generate_image and each narration with youzi_synthesize_speech, reusing consistent visual descriptions. Use the configured image size and voice unless the user requests a change. Use returned artifact_id values, never invent IDs.
